    ...
    if (!hasTracking) {
      return Center(child: Padding(padding: const EdgeInsets.all(40), child: Column(
        mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('Contact admin to enable live tracking', style: TextStyle(fontFamily: 'Inter', 
        ...
        if (_busLocation != null && students.isNotEmpty)
          Positioned(top: 12, left: 12, child: Container(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('LIVE', style: TextStyle(fontFamily: 'Inter', fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2, color: Colors.white)),
            ]),
          )),
            ...
            child: Row(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(students[_selectedChild.clamp(0, students.length - 1)].fullName.toUpperCase(),
                    style: TextStyle(fontFamily: 'Inter', fontSize: 13, fontWeight: FontWeight.w900, letterSpacing: -0.3, color: AppColors.slate800)),
              ...
              if (_busLocation != null)
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Text('${_speed.toStringAsFixed(0)} KM/H', style: TextStyle(fontFamily: 'Inter', 
        ...
        if (auth.user?.preferences.camera == true)
          Positioned(top: 12, right: 12, child: Container(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              const SizedBox(width: 4),
              Text('CAMERA', style: TextStyle(fontFamily: 'Inter', fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1, color: AppColors.primary)),
            ]),
          )),
      ])),
    ]);
