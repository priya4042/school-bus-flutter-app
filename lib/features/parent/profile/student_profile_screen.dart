...
class _StudentProfileScreenState extends State<StudentProfileScreen> {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text('+ ADD CHILD', style: TextStyle(fontFamily: 'Inter', 
            ...
            child: Column(children: [
              ...
              Transform.translate(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: 12),
                  Text(child.fullName, style: TextStyle(fontFamily: 'Inter', 
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('TRANSIT DETAILS', style: TextStyle(fontFamily: 'Inter', 
                ...
                ...attendance.records.take(10).map((r) => Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(Formatters.date(r.createdAt), style: TextStyle(fontFamily: 'Inter', 
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(value.toUpperCase(), style: TextStyle(fontFamily: 'Inter', 
  ...
  Widget _transitRow(IconData icon, String label, String value) {
    return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(width: 12),
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label, style: TextStyle(fontFamily: 'Inter', fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 2,
  ...
  Widget _feeStatBox(IconData icon, Color color, String label, String value) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(value, style: TextStyle(fontFamily: 'Inter', fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: -0.5, color: AppColors.slate900)),
      ]),
    );
  }
