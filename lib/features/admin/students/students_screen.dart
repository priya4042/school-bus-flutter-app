...
class _StudentsScreenState extends State<StudentsScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _deleteStudent(Student s) async {
    final ok = await showDialog<bool>(context: context, builder: (ctx) => AlertDialog(
      ...
      content: Text('A snapshot will be saved in Reports for deleted students.',
          style: TextStyle(fontFamily: 'Inter', fontSize: 12, color: AppColors.slate500)),
      actions: [
        ...
        ElevatedButton(onPressed: () => Navigator.pop(ctx, true),
            ...
            child: Text('DELETE', style: TextStyle(fontFamily: 'Inter', fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2))),
      ],
    ));
    if (ok == true) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(s.fullName.toUpperCase(), style: TextStyle(fontFamily: 'Inter', 
        ...
        PopupMenuButton<String>(
          ...
          itemBuilder: (_) => [
            PopupMenuItem(value: 'fees', child: Row(children: [
              ...
              Text('VIEW FEES', style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1)),
            ])),
            PopupMenuItem(value: 'edit', child: Row(children: [
              const Icon(Icons.edit_rounded, size: 16, color: AppColors.slate500),
              const SizedBox(width: 8),
              Text('EDIT', style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1)),
            ])),
            PopupMenuItem(value: 'delete', child: Row(children: [
              const Icon(Icons.delete_rounded, size: 16, color: AppColors.danger),
              const SizedBox(width: 8),
              Text('DELETE', style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 1, color: AppColors.danger)),
            ])),
          ],
          onSelected: (v) {
  ...
  Widget _buildYearlyFeesView(Student s) {
    ...
    return SingleChildScrollView(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        Expanded(child: Text('${s.fullName.toUpperCase()} — FEES', style: TextStyle(fontFamily: 'Inter', 
      ...
      crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (_editing == null) ...[
          ...
          SwitchListTile(
            ...
            title: Text('GENERATE FEE RECORDS', style: TextStyle(fontFamily: 'Inter', 
            ...
            Row(children: [
              Expanded(child: GestureDetector(
                ...
                child: Container(padding: const EdgeInsets.symmetric(vertical: 10),
                  ...
                  child: Center(child: Text('MONTHLY', style: TextStyle(fontFamily: 'Inter', 
              ...
              Expanded(child: GestureDetector(
                ...
                child: Container(padding: const EdgeInsets.symmetric(vertical: 10),
                  decoration: BoxDecoration(color: _yearlyMode ? AppColors.primary : AppColors.slate100, borderRadius: BorderRadius.circular(10)),
                  child: Center(child: Text('FINANCIAL YEAR', style: TextStyle(fontFamily: 'Inter', 
                    fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2, color: _yearlyMode ? Colors.white : AppColors.slate500)))),
              )),
            ]),
            const SizedBox(height: 12),
        ...
        SizedBox(width: double.infinity, height: 52, child: Container(
          ...
          child: ElevatedButton(onPressed: _saveStudent, style: AppTheme.primaryButton,
            child: Text(_editing != null ? 'UPDATE STUDENT' : 'REGISTER STUDENT',
                style: TextStyle(fontFamily: 'Inter', fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2))),
        )),
      ],
    )));
  }
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Day 1: ₹0  •  Day ${_fineAfterC + 1}: ₹${_finePerDayC.toInt()}  •  Day ${_fineAfterC + 7}: ₹${(_finePerDayC * 7).toInt()}',
                style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w700, color: AppColors.amber600)),
          ]),
        ),
        const SizedBox(height: 16),
        SizedBox(width: double.infinity, height: 52, child: ElevatedButton(
          onPressed: _createSingleFee, style: AppTheme.primaryButton,
          child: Text('CREATE FEE', style: TextStyle(fontFamily: 'Inter', fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2)))),
      ]));
    }
        ...
        Padding(padding: const EdgeInsets.all(16), child: Row(children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text('+ CREATE FEE', style: TextStyle(fontFamily: 'Inter', 
            ...
            itemBuilder: (_, i) {
              ...
              return Container(
                ...
                child: ExpansionTile(
                  ...
                  title: Text(student?.fullName.toUpperCase() ?? 'UNKNOWN', style: TextStyle(fontFamily: 'Inter', 
                    fontSize: 12, fontWeight: FontWeight.w900, color: AppColors.slate800)),
                  ...
                  children: dues.map((d) => Container(
                    ...
                    child: Row(children: [
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(d.monthLabel.toUpperCase(), style: TextStyle(fontFamily: 'Inter', 
  ...
  Widget _sectionLabel(String text, Color color) => Padding(
    ...
    child: Container(
      ...
      child: Text(text, style: TextStyle(fontFamily: 'Inter', fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 3, color: color)),
    ),
  );
  ...
  Widget _dropdown(String label, String? value, List<DropdownMenuItem<String>> items, Function(String?) onChanged) => Padding(
    ...
    child: DropdownButtonFormField<String>(
      ...
      style: TextStyle(fontFamily: 'Inter', fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.slate800),
      items: [DropdownMenuItem(value: null, child: Text('SELECT...', style: TextStyle(fontFamily: 'Inter', color: AppColors.slate400))), ...items],
      onChanged: onChanged),
  );
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Row(children: [
        ...
        Padding(padding: const EdgeInsets.symmetric(horizontal: 8),
          child: Text('$value', style: TextStyle(fontFamily: 'Inter', fontSize: 14, fontWeight: FontWeight.w900, color: AppColors.slate800))),
