        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Wrap(spacing: 8, runSpacing: 8, children: _msgTypes.map((t) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                child: Text(t.toUpperCase(), style: TextStyle(fontFamily: 'Inter', fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 1,
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontFamily: 'Inter', color: Colors.white.withOpacity(0.5)),
          ...
          SizedBox(width: double.infinity, height: 52, child: Container(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text('SEND BROADCAST', style: TextStyle(fontFamily: 'Inter', fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2))),
          )),
        ]),
      ),
        ...
        ...paymentNotifs.map((n) => Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(n.title, style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, color: AppColors.slate800)),
              Text(n.message, maxLines: 2, overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontFamily: 'Inter', fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.slate500)),
      ...
      if (recentBroadcasts.isEmpty)
        ...
        ...recentBroadcasts.map((n) => Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 10),
            Expanded(child: Text(n.title, style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, color: AppColors.slate800))),
            Text(Formatters.relativeTime(n.createdAt).toUpperCase(), style: AppTheme.labelXs.copyWith(color: AppColors.slate300)),
          ]),
        )),
    ]));
      ...
      itemBuilder: (_, i) {
        ...
        return Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(m['message'] ?? '', style: TextStyle(fontFamily: 'Inter', fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.slate700)),
            const SizedBox(height: 4),
            ...
            Row(children: [
              Expanded(child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Reply...', hintStyle: TextStyle(fontFamily: 'Inter', color: AppColors.slate400),
                  ...
                  return Container(
                    ...
                    child: Row(children: [
                      Container(
                        ...
                        child: Text(category, style: TextStyle(fontFamily: 'Inter', 
                          fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1.5, color: catColor)),
                      ),
                      const SizedBox(width: 10),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(action, style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, color: AppColors.slate800)),
