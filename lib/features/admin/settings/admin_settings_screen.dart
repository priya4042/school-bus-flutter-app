...
class _AdminSettingsScreenState extends State<AdminSettingsScreen> with SingleTickerProviderStateMixin {
          ...
          Container(padding: const EdgeInsets.all(20), decoration: AppTheme.cardLargeDecoration,
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('NO-SKIP CONSTRAINT', style: TextStyle(fontFamily: 'Inter', 
          ...
          Container(padding: const EdgeInsets.all(20), decoration: AppTheme.cardLargeDecoration,
            child: Column(children: [
              TextField(controller: _qrUrlCtrl,
                style: TextStyle(fontFamily: 'Inter', fontSize: 13, fontWeight: FontWeight.w700, color: AppColors.slate800),
          ...
          Row(children: [
            Expanded(child: SizedBox(height: 52, child: Container(
              ...
              child: ElevatedButton.icon(onPressed: _saveSettings, style: AppTheme.primaryButton,
                ...
                label: Text('COMMIT GLOBAL CHANGES', style: TextStyle(fontFamily: 'Inter', fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2))),
            ))),
            const SizedBox(width: 12),
            SizedBox(height: 52, child: ElevatedButton(onPressed: _resetDefaults, style: AppTheme.secondaryButton,
              child: Text('RESET', style: TextStyle(fontFamily: 'Inter', fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2)))),
          ]),
          const SizedBox(height: 20),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('ENFORCE 2FA', style: TextStyle(fontFamily: 'Inter', 
  ...
  Widget _settingRow(String label, TextEditingController ctrl, String hint) {
    return Row(children: [
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label, style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, color: AppColors.slate800)),
      ...
      SizedBox(width: 80, child: TextField(controller: ctrl, keyboardType: TextInputType.number, textAlign: TextAlign.center,
        style: TextStyle(fontFamily: 'Inter', fontSize: 16, fontWeight: FontWeight.w900, color: AppColors.primary),
  ...
  Widget _infoRow(String label, String value) => Padding(
    ...
    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      ...
      Text(value, style: TextStyle(fontFamily: 'Inter', fontSize: 11, fontWeight: FontWeight.w900, color: AppColors.slate800)),
    ]),
  );
