      ...
      return SingleChildScrollView(padding: const EdgeInsets.all(16), child: Form(key: _formKey,
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          DropdownButtonFormField<String>(value: _role,
            ...
            style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.slate800),
            items: [
              DropdownMenuItem(value: 'ADMIN', child: Text('STANDARD BUS ADMIN', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w700))),
              DropdownMenuItem(value: 'SUPER_ADMIN', child: Text('SUPER BUS ADMIN', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w700))),
            ],
          ...
          SizedBox(width: double.infinity, height: 52, child: Container(
            ...
            child: ElevatedButton(onPressed: _createAdmin, style: AppTheme.primaryButton,
              child: Text('CREATE ADMIN ACCOUNT', style: GoogleFonts.plusJakartaSans(fontSize: 10, fontWeight: FontWeight.w900, letterSpacing: 2))),
          )),
        ]),
      ));
    }
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('NEW ADMIN', style: GoogleFonts.plusJakartaSans(fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2, color: Colors.white)),
              ]),
            ),
          ),
        ])),
                    ...
                    return Container(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(a.fullName.toUpperCase(), style: GoogleFonts.plusJakartaSans(
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                          Container(
                            ...
                            child: Text(a.isSuperAdmin ? 'SUPER ADMIN' : 'STANDARD',
                                style: GoogleFonts.plusJakartaSans(fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: 1,
