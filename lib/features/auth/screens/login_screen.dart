                        ...
                        Form(
                          ...
                          child: Column(children: [
                            TextFormField(
                              ...
                              style: TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.w700, fontSize: 14, color: AppColors.slate800),
  ...
  Widget _toggleBtn(String label, bool isParent) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Center(child: Text(label, style: TextStyle(fontFamily: 'Inter', 
